...
% Calculate the year frac of the interpolation date using Act/365 convention
t_star = yearfrac(reference_date, interp_date, 3);
    
% Calculate the vector of year fracs of the given dates
taus = yearfrac(reference_date, dates, 3);
